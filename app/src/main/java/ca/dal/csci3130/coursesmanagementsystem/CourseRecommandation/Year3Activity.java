 ...
 *
 */
public class Year3Activity extends LevelActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //check faculty id, and show Year3Activity's Computer Science courses in fall and winter term
        switch (CourseRecommendActivity.getId()) {
            case R.id.BComputerScience:
                String[] fallTerm = {"-CSCI 3101.03: Social, Ethical, and Professional Issues in Computer Year2Activity", "-CSCI 3160.03: Designing User Interfaces", "-CSCI 3172.03: Web-Centric Computing", "-CSCI 3691.03: Intermediate Project", "-One 2000 Level Free Elective"};
                ArrayAdapter arrayAdapter1 = new ArrayAdapter<String>(Year3Activity.this, android.R.layout.simple_list_item_1, fallTerm);
                ...
                ArrayAdapter arrayAdapter2 = new ArrayAdapter<String>(Year3Activity.this, android.R.layout.simple_list_item_1, winterTerm);
                ListView lv2 = (ListView) findViewById(R.id.lv2);
                lv2.setAdapter(arrayAdapter2);
                break;
        }

        //check faculty id, and show Year3Activity's Science courses in fall and winter term
        switch (CourseRecommendActivity.getId()) {
            case R.id.BScience:
        ...
        //check faculty id, and show Year3Activity's Commerce courses in fall and winter term
        switch (CourseRecommendActivity.getId()) {
            case R.id.BCommerce:
        ...
        //check faculty id, and show Year3Activity's Art courses in fall and winter term
        switch (CourseRecommendActivity.getId()) {
            case R.id.BArts:
