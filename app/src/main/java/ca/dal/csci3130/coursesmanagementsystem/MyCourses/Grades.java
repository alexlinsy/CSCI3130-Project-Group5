...
public class Grades extends MyCourseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ListAdapter arrayAdapter = new ArrayAdapter<String>(ca.dal.csci3130.coursesmanagementsystem.MyCourses.Grades.this, android.R.layout.simple_list_item_1, arrayList);
                ListView lv=(ListView)findViewById(R.id.lv3);7
    ...
    public void onButtonClick(View v) {
        if (v.getId() == R.id.B6) {
        Intent intent = new Intent(Grades.this, AcademicTimeTableActivity.class);
