 ...
 * including the courses of year1 in each faculty
 *
 */
public class Year1 extends level {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * to show all the optional selections for Computer Science year1's fall-term courses
         */
        if (courseRecommand.getId() == R.id.BComputerScience) {
            ...
            /**
             * @param catch id in courseRecommend.class
             * to show all the optional selections for Computer Science year1's winter-term courses
             */
        ...
        /**
         * @param catch id in courseRecommend.class
         * to show all the optional selections for Science year1's fall-term courses
         */
        if (courseRecommand.getId() == R.id.BScience) {
            ...
            /**
             * @param catch id in courseRecommend.class
             * to show all the optional selections for Science year1's winter-term courses
             */
        ...
        /**
         * @param catch id in courseRecommend.class
         * to show all the optional selections for Commerce year1's fall-term courses
         */
        if (courseRecommand.getId() == R.id.BCommerce) {
            ...
            /**
             * @param catch id in courseRecommend.class
             * to show all the optional selections for Commerce year1's winter-term courses
             */
        ...
        /**
         * @param catch id in courseRecommend.class
         * to show all the optional selections for Art year1's fall-term courses
         */
        if (courseRecommand.getId() == R.id.BArts) {
            ...
            /**
             * @param catch id in courseRecommend.class
             * to show all the optional selections for Art year1's winter-term courses
             */
